...
#ifndef YY_NED2YY_NED2_TAB_H_INCLUDED
# define YY_NED2YY_NED2_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
int ned2yyparse (yyscan_t scanner, omnetpp::nedxml::ParseContext *np);

#endif /* !YY_NED2YY_NED2_TAB_H_INCLUDED  */
