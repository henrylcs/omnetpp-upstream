...
#ifndef YY_EXPRESSIONYY_EXPRESSION_TAB_H_INCLUDED
# define YY_EXPRESSIONYY_EXPRESSION_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
int expressionyyparse (yyscan_t scanner, AstNode *&resultAstTree);

#endif /* !YY_EXPRESSIONYY_EXPRESSION_TAB_H_INCLUDED  */
